...
The LNRUD generated by our Neural Rendering architecture can be downloaded from [LNRUD](https://pan.baidu.com/s/1zq8tRxbJb5rUZJbIPtBi9Q) &nbsp; **Password:djhh** or [Google Drive](https://drive.google.com/file/d/19cj8QI9SQhJgc4lxPLxZoTislTN7xLBF/view?usp=share_link), which contains 50000 clean images and 50000 underwater images synthesized from 5000 real underwater scene images.
...
You can download pre-trained model from [Pre-trained model](https://pan.baidu.com/s/1PA6sMo8MIr4HcaPOm6A15g) &nbsp; **Password:42w9** or [Google Drive](https://drive.google.com/file/d/1gpWDBrsyzDkP-MgTTmi7AM_ZEcno03Dc/view?usp=share_link) and save it in model_path. The Depth Net refers to [MegaDepth](https://github.com/zhengqili/MegaDepth) and we use the [depth pre-trained model](https://pan.baidu.com/s/1h1qx0Ju7UbyXpjxi2zKeag) &nbsp; **Password:mzqa** or [Google Drive](https://drive.google.com/file/d/1JLCxuyKrVGy4gIMJjpMdGnocXxTNRxAp/view?usp=share_link) from them. 
